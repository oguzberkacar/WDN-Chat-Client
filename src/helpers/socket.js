...
import { setNewMessage, setOnlineUsers, updateSignleMessage } from '../redux/actions';
...
export { SocketConnetion, socket, SendMessageToSocket, ChangeTheActiveUser, SendChatRoomMessageToSocket };
