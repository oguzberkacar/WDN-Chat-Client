import { CHAT_USER, ACTIVE_USER, FULL_USER, ADD_LOGGED_USER, CREATE_GROUP, ONLINE_USERS, LAST_MESSAGES, ACTIVE_CHAT, CHAT_LIST, ADD_CHAT_LIST, UPDATE_CHAT_LIST, ACTIVE_CHAT_ID, DELETE_CHAT, CHANGE_LAST_MESAGE, UPDATE_SINGLE_MESSAGE, CONNECTION_DATA, OLD_MESSAGE_LOADİNG, OLD_MESSAGE_LOADİNG_SUCCESS, OLD_MESSAGE_LOADİNG_ERROR, NEW_MESSAGE } from './constants';
	...
	switch (action.type) {
		...
		case UPDATE_SINGLE_MESSAGE:
			...
			chatListcopy4.map((chat) => {
				if (chat_id == chat.chat_id && updateSingleMessage.chatroom == undefined) {
