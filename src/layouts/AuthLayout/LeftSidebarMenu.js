...
function LeftSidebarMenu(props) {
	...
	const mode = modeLayout === 'dark' ? 'light' : 'dark';
						...
						<Nav pills className="side-menu-nav justify-content-center" role="tablist">
							...
							{!isUserLoggedIn && (
								<li className="nav-item  d-flex justify-content-center align-items-center">
									<a className=" d-flex flex-row flex-lg-column justify-content-center align-items-center gap-2" href={isUserLoggedIn ? '/logout' : '/login'}>
										<i className={`ri-logout-circle${!isUserLoggedIn ? '-r' : ''}-line text-muted order-2 order-lg-1`}></i>
							...
							<>
								<Dropdown nav isOpen={dropdownOpen} direction="left" className="nav-item btn-group dropup end profile-user-dropdown d-lg-none" toggle={toggle}>
									...
									<DropdownMenu right={true} className="dropdown-menu-translate-set">
										<DropdownItem id="light-dark" onClick={() => onChangeLayoutMode(mode)}>
					...
					<div className="flex-lg-column d-none d-lg-block">
						<Nav className="side-menu-nav justify-content-center">
							<div className="d-lg-block d-none">
								<Dropdown nav isOpen={dropdownOpen2} className="btn-group  profile-user-dropdown" toggle={toggle2}>
									<DropdownToggle nav>
										<i className="ri-global-line"></i>
									</DropdownToggle>
									<DropdownMenu>
								...
								{isUserLoggedIn && (
									<li className="nav-item">
										<a className=" d-flex flex-row flex-lg-column justify-content-center align-items-center gap-2" href="/logout">
											...
											<p className="text-white order-1 order-lg-1 mb-2" style={{ fontSize: '.75rem', marginBottom: '0' }}>
												Logout
											</p>
										</a>
									</li>
