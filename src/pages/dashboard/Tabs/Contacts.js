...
function Contacts(props) {
  ...
  async function getFollowers(id) {
    ...
    await fetch(
      `https://api.devapp.one/ads/followers?ads_id=${id}`,
      requestOptions
    )
          ...
          {props.user && props.user.ads ? (
            ...
            <div>
              <h5 className="text-center">
                Create an Ads account for see the followers.
              </h5>
            </div>
          )}
        </SimpleBar>
...
export default connect(mapStateToProps, { setActiveChatId, addNewChat })(
